...
import 'package:quran_api/database/bookmark.dart';
import 'package:quran_api/models/detail_surah_model.dart' as detailSurah;
...
class DetailSurahController with ChangeNotifier {
  ...
  // perintah memulai ulang audio yang ingin dinyalakan
  ...
  // perintah stop pada audio yang diputar
  ...
  // penambahan bookmark atau terakhir dibaca dari surah yang ingin ditandai
