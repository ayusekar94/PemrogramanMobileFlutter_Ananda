...
class HomeController with ChangeNotifier {
  ...
  // menampilkan data surat dari api 
  ...
  // menampilkan data penambahan bookmark(menggunakan database)
  ...
  // menampilkan data terakhir dilihat
